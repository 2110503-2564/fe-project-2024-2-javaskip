  ...
  return (
    <div className="w-[100%] h-[100%] min-w-[320px] min-h-[550px] bg-white rounded-[50px] flex flex-row border border-2">
      <div className="w-[40%] rounded-l-[50px] flex justify-center items-end bg-white">
        <div
          className={`w-full h-full py-[20px] rounded-bl-[50px] relative flex justify-center items-center `}
        >
          ...
          <div
            className={`absolute w-[100%] rounded-bl-[50px] bottom-0 py-[30px]  ${
              status === "PENDING"
                ? "bg-[#D9D9D9] bg-opacity-70"
                : status === "COMPLETE"
                ? "bg-fern bg-opacity-60"
                : "bg-white"
            }`}
          >
            {status === "PENDING" ? (
              ...
              <div className="flex flex-row justify-center items-center space-x-[20px]">
                {" "}
                <CheckCircleIcon sx={{ fontSize: "50px", color: "#29FB57" }} />
                <div className="font-bold text-[40px] text-white drop-shadow-md">
                  Payment Completed
                </div>
              </div>
