    ...
    <main>
      ...
      <div className="my-[10px] text-left text-black text-center">
        ...
        <div className="flex flex-row justify-center ">
          <div>
            <div className="text-md font-medium mt-[20px]">Address</div>
            <div className="text-md">{campgroundDetail.data.address}</div>
          </div>
         
        </div>
        
        <div className="text-md font-medium mt-[20px]">Phone Number</div>
        <div className="text-md">{campgroundDetail.data.tel}</div>
      </div>
